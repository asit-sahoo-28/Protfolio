...
const Certification = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen text-gray-400 text-xl bg-[#0b0b0f]">
        Loading Certifications...
      </div>
    );
  }
  ...
  return (
    <div className="px-6 md:px-16 lg:px-32 py-16 bg-[#0b0b0f] transition-colors duration-300">
      {/* Section Title */}
      <SectionTitle title="Certifications" />
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-10">
        ...
        >
          {certifications.map((cert, index) => (
            <div
              ...
              className={`flex-shrink-0 cursor-pointer transition-all duration-300 rounded-md px-4 py-2 ${
                selectItem === index
                  ? "bg-purple-500/20 border-b-4 md:border-b-0 md:border-l-4 border-purple-500 text-purple-400 translate-x-1"
        ...
        {/* Card */}
        <div className="flex flex-col lg:flex-row gap-8 items-center bg-[#16161d] border border-white/10 rounded-2xl shadow-xl p-6 md:p-8 transition-all duration-300 w-full">
          
          {/* Image */}
          <div className="w-full lg:w-1/2 rounded-xl overflow-hidden border border-white/10">
            <img
              src={certifications[selectItem].image}
              alt={certifications[selectItem].title}
              className="w-full h-64 md:h-80 object-cover hover:scale-105 transition-transform duration-500"
          ...
          <div className="flex-1 text-gray-400 leading-relaxed">
            ...
            {certifications[selectItem].link && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 mt-4 rounded-full transition shadow-lg"
              >
                View Certificate
              </a>
            )}
